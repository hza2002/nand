...
<div align="center">
{{< figure default=true src="bic.png" width=50% >}}
</div>
...
<details open>
<summary>Laplacian Image Enhancement Example</summary>
<div class="image-comparison-container" style="display: grid; grid-template-columns: repeat(auto-fill, minmax(250px, 1fr)); gap: 10px;">
  {{< compare before="原图.jpeg" after="拉普拉斯.jpeg" >}}
  {{< compare before="原图1.jpeg" after="拉普拉斯1.jpeg" >}}
</div>
</details>