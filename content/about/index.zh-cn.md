...
<table>
    ...
    <tbody>
        <tr>
            <td><img class="customEntitityAlbum" src="owl.png"/></td>
            <td><a target="_blank" href="https://github.com/hza2002/owl">Owl{{< badge >}} 活跃 {{< /badge >}}</a></td>
            <td>舒适灵活的分体式无线键盘</td>
        </tr>
        <tr>
            <td><img class="customEntitityAlbum" src="VisionGuard.png"/></td>
            <td><a target="_blank" href="https://github.com/hza2002/VisionGuard">Vision Guard</a></td>
            <td>智能监控和安全系统</td>
        </tr>
        <tr>
            <td><img class="customEntitityAlbum" src="SubwayRouteFinder.png"/></td>
            <td><a target="_blank" href="https://github.com/hza2002/SubwayRouteFinder">Subway Route Finder</a></td>
            <td>重庆地铁线路快捷查询系统</td>
        </tr>
        <tr>
            <td><img class="customEntitityAlbum" src="BudgetBuddy.png"/></td>
            <td><a target="_blank" href="https://github.com/hza2002/BudgetBuddy">Budget Buddy</a></td>
            <td>财务管理器，导入微信/支付宝账单，分析生成报告</td>
        </tr>
         <tr>
            <td><img class="customEntitityAlbum" src="MoonPhaseTracker.png"/></td>
            <td><a target="_blank" href="https://github.com/hza2002/MoonPhaseTracker">Moon Phase Tracker</a></td>
            <td>查询任何所选日期的月相</td>
        </tr>
        <tr>
            <td><img class="customEntitityAlbum" src="WordWise.png"/></td>
...
<table>
    ...
    <tbody>
         <tr>
            <td><img class="customEntitityLogo" src="Digiwin.png"/></td>
         ...
         <tr>
            <td><img class="customEntitityLogo" src="iFlytek.jpg"/></td>
...
<table>
    ...
    <tbody>
        <tr>
            <td><img class="customEntitityLogo" src="Southwest_University.png"/></td>
            <td><a href="https://www.swu.edu.cn/" target="_blank">西南大学</a></td>
            <td>计算机科学本科</td>
            <td>2021 - 2025</td>
        </tr>
        <tr>
            <td><img class="customEntitityLogo" src="Wenzhou_High_School.png"/></td>
            <td><a href="http://wzms.wzer.net/" target="_blank">温州中学</a></td>
            <td>高中</td>
            <td>2019 - 2021</td>
        </tr>
        <tr>
            <td><img class="customEntitityLogo" src="Wenzhou_Foreign_Language_School.jpeg"/></td>
