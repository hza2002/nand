...
<table>
    ...
    <tbody>
         <tr>
            <td>{{< figure class="customEntitityLogo" src="Digiwin.png" >}}</td>
         ...
         <tr>
            <td>{{< figure class="customEntitityLogo" src="iFlytek.jpg" >}}</td>
...
<table>
    ...
    <tbody>
        <tr>
            <td>{{< figure class="customEntitityLogo" src="Southwest_University.png" >}}</td>
            <td><a href="https://www.swu.edu.cn/" target="_blank">西南大学</a></td>
            <td>计算机科学本科</td>
            <td>2021 - 2025</td>
        </tr>
        <tr>
            <td>{{< figure class="customEntitityLogo" src="Wenzhou_High_School.png" >}}</td>
            <td><a href="http://wzms.wzer.net/" target="_blank">温州中学</a></td>
            <td>高中</td>
            <td>2018 - 2021</td>
        </tr>
        <tr>
            <td>{{< figure class="customEntitityLogo" src="Wenzhou_Foreign_Language_School.jpeg" >}}</td>
